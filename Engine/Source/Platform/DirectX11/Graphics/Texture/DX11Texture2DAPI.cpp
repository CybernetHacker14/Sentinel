...
namespace Sentinel {
    ...
    void* DX11Texture2DAPI::GetResource(Texture2DData* dataObject) {
        DX11Texture2DData* texture = Texture2DAPI::Cast<DX11Texture2DData>(dataObject);
        return texture->m_ResourceView;
    }
    ...
    void DX11Texture2DAPI::Load(DX11Texture2DData* dataObject, UInt32 width, UInt32 height, UInt8 channels) {
        ID3D11Texture2D* texture2D = nullptr;
