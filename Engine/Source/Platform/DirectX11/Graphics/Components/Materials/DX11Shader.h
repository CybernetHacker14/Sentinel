...
namespace Sentinel
{
	...
	public:
		...
		inline const STL::string& GetShaderSource(const ShaderType& type) { return m_ShaderSourceMap.at(type); }
		inline const STL::string& GetName() { return m_ShaderName; }
		inline const STL::string& GetFilepath() { return m_FilePath; }
