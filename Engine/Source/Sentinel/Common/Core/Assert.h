...
#define ST_INTERNAL_ASSERT_NO_MSG(type, check) ST_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", ST_STRINGIFY_MACRO(check), Sentinel::Filesystem::GetFilenameWithExtension(__LINE__).c_str(), __LINE__)
