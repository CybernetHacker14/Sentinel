...
namespace Sentinel {
    ...
    Float SIMDMath::SSESquareRoot(Float number) { return _mm_cvtss_f32(_mm_sqrt_ss(_mm_set_ss(number))); }

    Float SIMDMath::SSECos(Float radians) { return _mm_cvtss_f32(_mm_cos_ps(_mm_set_ss(radians))); }

    Float SIMDMath::SSESin(Float radians) { return _mm_cvtss_f32(_mm_sin_ps(_mm_set_ss(radians))); }
